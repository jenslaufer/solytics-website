<template>
  <article class="prose-article">
    <h2>E-Rechnung mit DATEV: Warum die Umstellung jetzt ansteht</h2>
    <p>
    ...
    <h2>Warum E-Rechnung in DATEV?</h2>
    <p>
    ...
    <h2>DATEV-Module für die E-Rechnung: Welches passt zu Ihrem Unternehmen?</h2>
    <p>
    ...
    <ul>
      <li><strong>Vorteile:</strong> Einfache Bedienung, automatische Belegerkennung, direkte Kanzleianbindung.</li>
      <li><strong>Einschränkungen:</strong> Keine Rechnungserstellung — nur Empfang und Verarbeitung eingehender Belege.</li>
    </ul>

    <h3>DATEV Mittelstand pro / Mittelstand Faktura</h3>
    <p>
    ...
    <ul>
      <li><strong>Vorteile:</strong> Rechnungserstellung + Buchhaltung in einem System, nahtlose Steuerberater-Schnittstelle.</li>
      <li><strong>Einschränkungen:</strong> Höhere Kosten, mehr Einarbeitung als Unternehmen online.</li>
    </ul>

    <h3>DATEV-Schnittstellen für Drittsoftware</h3>
    <p>
    ...
    <h2>Schritt-für-Schritt: XRechnung in DATEV einrichten</h2>

    <h3>Schritt 1: DATEV-Umgebung prüfen</h3>
    <p>
    ...
    <h3>Schritt 2: E-Rechnungsempfang aktivieren</h3>
    <p>
      In DATEV Unternehmen online: Navigieren Sie zu <em>Belege online → Einstellungen → Belegtypen</em>. Aktivieren Sie den Import für XRechnung (XML) und ZUGFeRD (PDF mit eingebettetem XML). Legen Sie ein dediziertes E-Mail-Postfach an (z. B. <em>rechnung@ihre-firma.de</em>) und konfigurieren Sie die automatische Weiterleitung an DATEV Unternehmen online.
    </p>

    <h3>Schritt 3: Belegverarbeitung konfigurieren</h3>
    <p>
    ...
    <h3>Schritt 4: Rechnungsversand einrichten (Mittelstand pro)</h3>
    <p>
      Falls Sie DATEV Mittelstand pro nutzen: Unter <em>Faktura → Einstellungen → Ausgabeformat</em> wählen Sie XRechnung oder ZUGFeRD als Standard-Rechnungsformat. Hinterlegen Sie die Leitweg-ID Ihrer Geschäftspartner in den Kundenstammdaten. Testen Sie den Versand mit einer Proberechnung.
    </p>

    <h3>Schritt 5: Steuerberater einbinden</h3>
    <p>
    ...
    <h3>Schritt 6: Testlauf und Validierung</h3>
    <p>
      Erstellen Sie eine Testrechnung und validieren Sie diese mit dem Prüftool der KoSIT (<em>validator.kosit.org</em>). Senden Sie die Testrechnung an einen Geschäftspartner und bitten Sie um Rückmeldung. Prüfen Sie gleichzeitig, ob eingehende E-Rechnungen korrekt in DATEV importiert und verbucht werden.
    </p>

    <h2>Häufige Fehler bei der DATEV-Einrichtung</h2>
    <p>
      Die technische Einrichtung ist meist unkompliziert — die typischen Probleme liegen im Detail:
    </p>
    <ul>
      <li><strong>Fehlende Updates:</strong> DATEV aktualisiert die E-Rechnungsfunktionen regelmäßig. Wer Updates auslässt, arbeitet mit veralteten Validierungsregeln und riskiert fehlerhafte Rechnungen.</li>
      <li><strong>Falsche Belegtyp-Zuordnung:</strong> XRechnung-XML-Dateien werden als „sonstige Belege" statt als Eingangsrechnungen erkannt, wenn die Belegtyp-Konfiguration nicht stimmt.</li>
      <li><strong>Leitweg-ID fehlt:</strong> Ohne korrekte Leitweg-ID werden XRechnungen an öffentliche Auftraggeber abgelehnt. Prüfen Sie die ID im Leitweg-ID-Verzeichnis.</li>
      <li><strong>Archivierung nicht GoBD-konform:</strong> E-Rechnungen in DATEV Unternehmen online sind automatisch revisionssicher archiviert. Aber: Wer E-Rechnungen zusätzlich ausdruckt und den Ausdruck als Beleg behandelt, verletzt die GoBD — der maschinenlesbare Datensatz ist der Originalbeleg.</li>
      <li><strong>Steuerberater nicht eingebunden:</strong> Die Umstellung funktioniert nur, wenn beide Seiten — Unternehmen und Kanzlei — auf dem gleichen Stand sind. Einseitige Änderungen führen zu Dateninkonsistenzen.</li>
      <li><strong>ZUGFeRD-Version zu alt:</strong> Nur ZUGFeRD ab Version 2.0.1 ist EN-16931-konform. Ältere Versionen erfüllen die gesetzliche Anforderung nicht.</li>
    </ul>

    <h2>Wann lohnt sich externe Hilfe?</h2>
    <p>
    ...
    <ul>
      <li>Sie mehrere Systeme anbinden müssen (ERP, Warenwirtschaft, Branchensoftware + DATEV).</li>
      <li>Sie regelmäßig an öffentliche Auftraggeber liefern und XRechnung mit Leitweg-ID korrekt abbilden müssen.</li>
      <li>Ihr Rechnungsvolumen hoch ist und Sie automatische Validierung und Fehlerbehandlung benötigen.</li>
      <li>Sie die Umstellung als Anlass nehmen, Ihren gesamten Belegfluss zu digitalisieren.</li>
    </ul>
    <p>
      Solytics unterstützt Unternehmen bei der E-Rechnungseinführung — von der Bestandsaufnahme über die DATEV-Konfiguration bis zur Steuerberater-Schnittstelle. Mehr erfahren Sie unter
      <a href="https://solytics.de/e-rechnung" target="_blank" rel="noopener">solytics.de/e-rechnung</a>.
    </p>

    <h2>Fazit: DATEV macht die Umstellung einfacher — wenn die Einrichtung stimmt</h2>
    <p>
    ...
    <RelatedArticles slug="e-rechnung-datev" />
  </article>
</template>

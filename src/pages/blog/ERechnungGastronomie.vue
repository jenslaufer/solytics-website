<template>
  <article class="prose-article">
    <h2>E-Rechnung in der Gastronomie: Warum Restaurants, Hotels und Caterer jetzt handeln müssen</h2>
    <p>
    ...
    <ul>
      <li><strong>XRechnung:</strong> Reines XML — nur maschinenlesbar, kein sichtbares Dokument.</li>
      <li><strong>ZUGFeRD (ab Version 2.0):</strong> PDF mit eingebetteten XML-Daten — sieht aus wie eine normale Rechnung, ist aber maschinenverarbeitbar.</li>
    </ul>
    <p>
    ...
    <h2>Der Zeitplan: Welche Fristen gelten?</h2>
    <table>
      <thead>
        <tr><th>Datum</th><th>Was passiert?</th><th>Relevanz für Gastronomie</th></tr>
      </thead>
      <tbody>
        <tr><td><strong>01.01.2025</strong></td><td>Empfangspflicht</td><td>Alle Betriebe müssen E-Rechnungen von Lieferanten empfangen und verarbeiten können.</td></tr>
        <tr><td><strong>01.01.2027</strong></td><td>Versandpflicht (Stufe 1)</td><td>Betriebe mit über 800.000 € Vorjahresumsatz müssen E-Rechnungen versenden.</td></tr>
        <tr><td><strong>01.01.2028</strong></td><td>Versandpflicht für alle</td><td>Alle Gastronomiebetriebe, unabhängig vom Umsatz. Meldesystem startet.</td></tr>
      </tbody>
    </table>
    <p>
    ...
    <h2>Besonderheiten der Gastronomie</h2>

    <h3>TSE und E-Rechnung: Zwei getrennte Welten</h3>
    <p>
    ...
    <table>
      <thead>
        <tr><th>Thema</th><th>TSE (Kassensicherungsverordnung)</th><th>E-Rechnung (Wachstumschancengesetz)</th></tr>
      </thead>
      <tbody>
        <tr><td>Was?</td><td>Manipulationsschutz für Kassendaten</td><td>Strukturiertes Rechnungsformat für B2B</td></tr>
        <tr><td>Wer?</td><td>Jeder Betrieb mit Registrierkasse</td><td>Jeder Betrieb mit B2B-Umsätzen</td></tr>
        <tr><td>Format</td><td>DSFinV-K Export</td><td>XRechnung oder ZUGFeRD</td></tr>
        <tr><td>Seit wann?</td><td>Seit 2020 Pflicht</td><td>Empfang seit 2025, Versand ab 2027</td></tr>
      </tbody>
    </table>
    <p>
    ...
    <ul>
      <li>Kann das System XRechnung oder ZUGFeRD exportieren?</li>
      <li>Gibt es ein Rechnungsmodul für B2B-Kunden (nicht nur Kassenbons)?</li>
      <li>Ist ein Update oder Zusatzmodul geplant?</li>
    </ul>
    <p>
    ...
    <h3>Bewirtungsbelege: Sonderfall für die Gastronomie</h3>
    <p>
    ...
    <h3>Umsatzsteuer: 7 % vs. 19 % in der Gastronomie</h3>
    <p>
    ...
    <h2>Welche Betriebstypen sind betroffen?</h2>
    ...
    <ul>
      <li>Gemischte Steuersätze (Übernachtung 7 %, Frühstück 19 %, Minibar 19 %)</li>
      <li>Sammelrechnungen für mehrtägige Aufenthalte</li>
      <li>Buchungen über Plattformen (Booking.com, HRS) — wer stellt die E-Rechnung aus?</li>
    </ul>

    <h3>Catering-Unternehmen</h3>
    <p>
    ...
    <h3>Kantinen und Gemeinschaftsverpflegung</h3>
    <p>
    ...
    <h2>Schritt für Schritt: So bereiten Sie Ihren Betrieb vor</h2>

    <h3>1. B2B-Anteil ermitteln</h3>
    <p>
    ...
    <h3>3. Empfang einrichten (sofort)</h3>
    <p>
    ...
    <ul>
      <li><router-link to="/blog/e-rechnung-lexoffice">E-Rechnung mit Lexoffice</router-link></li>
      <li><router-link to="/blog/e-rechnung-sevdesk">E-Rechnung mit sevDesk</router-link></li>
    </ul>

    <h3>4. Rechnungssoftware für B2B einführen</h3>
    <p>
      Falls Ihr Kassensystem keine E-Rechnungen erstellen kann, nutzen Sie eine separate Rechnungssoftware für B2B-Kunden. Vergleichen Sie Optionen in unserem <router-link to="/blog/e-rechnung-software-vergleich-2026">Software-Vergleich 2026</router-link>.
    </p>

    <h3>5. Prozesse anpassen</h3>
    <p>
    ...
    <h3>6. Steuerberater einbinden</h3>
    <p>
      Sprechen Sie mit Ihrem Steuerberater über die Umstellung. Klären Sie: Schnittstellen zwischen Kassensystem, Rechnungssoftware und DATEV. Mehr dazu: <router-link to="/blog/e-rechnung-datev">E-Rechnung mit DATEV</router-link>.
    </p>

    <h2>Häufige Fragen aus der Gastronomie</h2>

    <h3>„Muss ich für jeden Kassenbon eine E-Rechnung erstellen?"</h3>
    <p>
    ...
    <h3>„Ich bin Kleinunternehmer nach § 19 UStG. Gilt die Pflicht trotzdem?"</h3>
    <p>
      Ja. Auch Kleinunternehmer müssen ab 2025 E-Rechnungen empfangen. Die Versandpflicht greift je nach Umsatz ab 2027 oder 2028. Die Kleinunternehmerregelung befreit nicht von der E-Rechnungspflicht. Mehr dazu: <router-link to="/blog/e-rechnung-kleinunternehmer">E-Rechnung für Kleinunternehmer</router-link>.
    </p>

    <h3>„Was passiert, wenn ich nicht umstelle?"</h3>
    <p>
    ...
    <h3>„Kann ich E-Rechnung und Kassenbon parallel führen?"</h3>
    <p>
    ...
    <h2>Checkliste: E-Rechnung in der Gastronomie</h2>
    <table>
      <thead>
        <tr><th>Aufgabe</th><th>Frist</th><th>Status</th></tr>
      </thead>
      <tbody>
        <tr><td>E-Rechnungen empfangen können (E-Mail + Software)</td><td>Sofort (Pflicht seit 01.01.2025)</td><td>☐</td></tr>
        <tr><td>B2B-Anteil analysieren</td><td>Q2 2026</td><td>☐</td></tr>
        <tr><td>Kassenhersteller nach E-Rechnungsmodul fragen</td><td>Q2 2026</td><td>☐</td></tr>
        <tr><td>Rechnungssoftware für B2B evaluieren</td><td>Q3 2026</td><td>☐</td></tr>
        <tr><td>Testrechnung im ZUGFeRD-Format erstellen</td><td>Q4 2026</td><td>☐</td></tr>
        <tr><td>Archivierung GoBD-konform einrichten</td><td>Q4 2026</td><td>☐</td></tr>
        <tr><td>Steuerberater über DATEV-Schnittstelle informieren</td><td>Q4 2026</td><td>☐</td></tr>
        <tr><td>E-Rechnungsversand an B2B-Kunden starten</td><td>Spätestens 01.01.2027/2028</td><td>☐</td></tr>
      </tbody>
    </table>
    ...
    <p>
      Sie brauchen Unterstützung bei der Umstellung? <router-link to="/e-rechnung#kontakt">Sprechen Sie uns an</router-link> — wir begleiten Gastronomiebetriebe von der Analyse bis zur fertigen Implementierung.
    </p>

    <RelatedArticles slug="e-rechnung-gastronomie" />
  </article>
</template>

<template>
  <article class="prose-article">
    <h2>E-Rechnung im Handwerk: Warum gerade Handwerksbetriebe jetzt handeln müssen</h2>
    <p>
    ...
    <ul>
      <li><strong>XRechnung:</strong> Reines XML-Format — nur maschinenlesbar, kein sichtbares Dokument.</li>
      <li><strong>ZUGFeRD (ab Version 2.0):</strong> PDF mit eingebetteten XML-Daten — menschenlesbar und maschinenverarbeitbar zugleich.</li>
    </ul>
    <p>
    ...
    <table>
      <thead>
        <tr><th>Datum</th><th>Was passiert?</th><th>Betrifft welche Handwerksbetriebe?</th></tr>
      </thead>
      <tbody>
        <tr><td><strong>01.01.2025</strong></td><td>Empfangspflicht</td><td>Alle Betriebe müssen E-Rechnungen empfangen und verarbeiten können.</td></tr>
        ...
        <tr><td><strong>01.01.2028</strong></td><td>Versandpflicht für alle</td><td>Alle Betriebe, unabhängig vom Umsatz. Gleichzeitig startet das Meldesystem.</td></tr>
      </tbody>
    </table>
    <p>
    ...
    <h2>Was ändert sich konkret für Handwerksbetriebe?</h2>

    <h3>Rechnungserstellung</h3>
    <p>
    ...
    <h2>Sonderfälle im Handwerk: Abschlag, Aufmaß, Kleinbetrag</h2>

    <h3>Abschlagsrechnungen</h3>
    <p>
    ...
    <h3>Aufmaß und Leistungsverzeichnis</h3>
    <p>
    ...
    <h3>Kleinbetragsrechnungen bis 250 Euro</h3>
    <p>
    ...
    <h2>Schritt-für-Schritt: So bereiten Sie Ihren Handwerksbetrieb vor</h2>
    ...
    <h3>Schritt 2: Software prüfen oder wechseln</h3>
    <p>
    ...
    <h3>Schritt 3: E-Mail-Empfang einrichten</h3>
    <p>
      Richten Sie ein separates E-Mail-Postfach für eingehende E-Rechnungen ein, z. B. <em>rechnung@ihre-firma.de</em>. Stellen Sie sicher, dass XML-Anhänge nicht vom Spamfilter blockiert werden. Viele E-Mail-Provider filtern unbekannte Dateitypen — testen Sie das aktiv.
    </p>

    <h3>Schritt 4: Steuerberater einbinden</h3>
    <p>
    ...
    <h3>Schritt 5: Testlauf starten</h3>
    <p>
    ...
    <h3>Schritt 6: Mitarbeiter schulen</h3>
    <p>
    ...
    <h3>„Ich mache alles über den Steuerberater — betrifft mich das trotzdem?"</h3>
    <p>
    ...
    <h3>„Muss ich für Privatkunden auch E-Rechnungen erstellen?"</h3>
    <p>
    ...
    <h3>„Ich habe unter 800.000 Euro Umsatz — habe ich noch Zeit?"</h3>
    <p>
    ...
    <h3>„Kann ich nicht einfach bei PDF bleiben?"</h3>
    <p>
    ...
    <h2>Typische Fehler, die Handwerksbetriebe vermeiden sollten</h2>
    <ul>
      <li><strong>Zu spät anfangen:</strong> Softwareumstellungen im Handwerk brauchen erfahrungsgemäß 3–6 Monate. Wer im November 2026 beginnt, hat ein Problem.</li>
      <li><strong>Zwei Systeme parallel betreiben:</strong> Vermeiden Sie es, für E-Rechnungen und klassische Rechnungen unterschiedliche Tools zu nutzen. Das verdoppelt den Aufwand und erhöht die Fehlerquote.</li>
      <li><strong>Abschlagsrechnungen vergessen:</strong> Viele denken nur an Schlussrechnungen. Auch jede Abschlagsrechnung muss als E-Rechnung erstellt werden.</li>
      <li><strong>Archivierung ignorieren:</strong> E-Rechnungen im E-Mail-Postfach liegen lassen ist nicht GoBD-konform. Sie brauchen eine revisionssichere Archivierung.</li>
      <li><strong>§ 13b-Fälle falsch abbilden:</strong> Reverse-Charge-Rechnungen haben besondere Anforderungen im E-Rechnungsformat. Testen Sie diese Fälle explizit.</li>
    </ul>

    <h2>Was Solytics für Handwerksbetriebe tut</h2>
    <p>
    ...
    <ul>
      <li><strong>Bestandsaufnahme und Softwarecheck:</strong> Wir analysieren Ihre aktuelle Rechnungssoftware und prüfen, ob sie E-Rechnungen unterstützt oder ersetzt werden muss.</li>
      <li><strong>Einrichtung und Konfiguration:</strong> Wir richten Ihre E-Rechnungslösung ein — inklusive ZUGFeRD/XRechnung-Erzeugung, E-Mail-Konfiguration und Archivierung.</li>
      <li><strong>Schulung:</strong> Kompakte Einweisung für Sie und Ihr Team, damit der neue Prozess ab Tag eins reibungslos läuft.</li>
      <li><strong>Steuerberater-Schnittstelle:</strong> Wir stellen sicher, dass Ihre Belege nahtlos an den Steuerberater übergeben werden — digital, automatisiert und fehlerfrei.</li>
    </ul>
    <p>
    ...
    <h2>Fazit: Jetzt vorbereiten, 2027 entspannt starten</h2>
    <p>

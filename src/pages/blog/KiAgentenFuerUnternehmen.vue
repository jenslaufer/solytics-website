<template>
  <article class="prose-article">
    ...
    <h3>Die Kernfähigkeiten eines KI-Agenten</h3>
    <ul>
      <li><strong>Planung:</strong> Der Agent zerlegt komplexe Aufgaben in Teilschritte und bestimmt die optimale Reihenfolge.</li>
      <li><strong>Tool-Nutzung:</strong> Agenten können APIs aufrufen, Datenbanken abfragen, Dateien lesen und schreiben, E-Mails versenden oder Webseiten analysieren.</li>
      <li><strong>Entscheidungsfähigkeit:</strong> Basierend auf Zwischenergebnissen passt der Agent seine Strategie an — ähnlich wie ein Mensch, der auf unerwartete Situationen reagiert.</li>
      <li><strong>Gedächtnis:</strong> Moderne Agenten können Kontext über mehrere Interaktionen hinweg behalten und aus vergangenen Aufgaben lernen.</li>
    </ul>

    <h2>Konkrete Anwendungsfälle in Unternehmen</h2>
    <p>
      KI-Agenten sind keine Zukunftsmusik — sie werden bereits heute in Unternehmen eingesetzt.
    </p>

    <h3>1. Automatisierte Datenverarbeitung und Reporting</h3>
    <p>
    ...
    <blockquote>
      <strong>Praxisbeispiel:</strong> Ein mittelständisches Handelsunternehmen lässt einen KI-Agenten täglich Verkaufsdaten aus drei verschiedenen Systemen zusammenführen und automatisch einen Management-Report generieren. Was vorher einen halben Arbeitstag in Anspruch nahm, erledigt der Agent in unter fünf Minuten.
    </blockquote>

    <h3>2. Intelligente Dokumentenverarbeitung</h3>
    <p>
    ...
    <h3>3. Kundenservice und Support</h3>
    <p>
    ...
    <h3>4. Softwareentwicklung und Code-Automatisierung</h3>
    <p>
    ...
    <h3>5. Recherche und Marktanalyse</h3>
    <p>
    ...
    <h2>ROI: Was bringen KI-Agenten konkret?</h2>
    <p>
    ...
    <table>
      <thead>
        <tr><th>Bereich</th><th>Verbesserung</th></tr>
      </thead>
      <tbody>
        <tr><td>Reporting</td><td>70 % Zeitersparnis bei Datenaufbereitung und Berichterstellung</td></tr>
        <tr><td>Dokumentenverarbeitung</td><td>50 % weniger Fehler durch maschinelle Extraktion und Validierung</td></tr>
        <tr><td>Bearbeitungszeiten</td><td>3x schnellere Durchlaufzeiten bei Kundenanfragen</td></tr>
        <tr><td>Routinetätigkeiten</td><td>85 % Automatisierungsgrad bei wiederkehrenden Aufgaben</td></tr>
      </tbody>
    </table>

    <h2>Wie funktioniert die Einführung von KI-Agenten?</h2>

    <h3>Phase 1: Prozessanalyse und Identifikation</h3>
    <p>
    ...
    <h3>Phase 2: Prototyp und Validierung</h3>
    <p>
    ...
    <h3>Phase 3: Produktivsetzung und Skalierung</h3>
    <p>
    ...
    <ul>
      <li><strong>Datenhoheit:</strong> Ihre Daten bleiben in Ihrer Infrastruktur oder bei einem europäischen Cloud-Anbieter.</li>
      <li><strong>DSGVO-Konformität:</strong> Alle Verarbeitungsprozesse werden DSGVO-konform gestaltet.</li>
      <li><strong>Transparenz:</strong> Jede Aktion des Agenten wird protokolliert und ist nachvollziehbar.</li>
      <li><strong>Zugriffskontrolle:</strong> Agenten erhalten nur die minimal notwendigen Berechtigungen.</li>
    </ul>

    <h2>KI-Agenten vs. klassische Automatisierung</h2>
    <p>

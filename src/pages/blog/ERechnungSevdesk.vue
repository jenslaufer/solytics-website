<template>
  <article class="prose-article">
    <h2>E-Rechnung mit sevDesk: XRechnung automatisch erstellen und versenden</h2>
    <p>
    ...
    <h2>sevDesk E-Rechnungs-Features im Überblick</h2>

    <h3>XRechnung und ZUGFeRD direkt aus der Oberfläche</h3>
    <p>
    ...
    <h3>REST-API für automatisierte Workflows</h3>
    <p>
    ...
    <p>
      Ein typischer API-Workflow sieht so aus: Ihr System erstellt eine Rechnung über <code>POST /api/v1/Invoice</code>, fügt Positionen hinzu und löst den Versand aus. sevDesk generiert automatisch das gewählte E-Rechnungsformat und stellt die Datei zum Download oder Direktversand bereit.
    </p>
    <p>
    ...
    <h3>ZUGFeRD-Profile und Kompatibilität</h3>
    <p>
    ...
    <h2>XRechnung-Format einrichten: Schritt für Schritt</h2>
    <p>
      Die Einrichtung in sevDesk ist unkompliziert:
    </p>
    <ol>
      <li><strong>Unternehmensdaten vervollständigen:</strong> Umsatzsteuer-ID, Bankverbindung und Handelsregisternummer unter Einstellungen → Unternehmen eintragen.</li>
      <li><strong>Rechnungsformat wählen:</strong> Unter Einstellungen → Rechnungen das Standard-Format auf XRechnung oder ZUGFeRD EN 16931 setzen.</li>
      <li><strong>Leitweg-ID hinterlegen:</strong> Für Rechnungen an öffentliche Auftraggeber die Leitweg-ID des Empfängers im Kontaktdatensatz speichern.</li>
      <li><strong>Testrechnung erstellen:</strong> Eine Rechnung im gewählten Format erzeugen und mit dem KoSIT-Validator prüfen.</li>
      <li><strong>Versandkanal konfigurieren:</strong> E-Mail-Versand oder Peppol-Zugang einrichten, je nach Empfängeranforderung.</li>
    </ol>
    <p>
    ...
    <h2>Rechnungsversand per API automatisieren</h2>
    <p>
    ...
    <ol>
      <li><strong>Kontakt anlegen oder abrufen:</strong> <code>GET /api/v1/Contact</code> prüft, ob der Kunde existiert. Falls nicht, legt <code>POST /api/v1/Contact</code> ihn an.</li>
      <li><strong>Rechnung erstellen:</strong> <code>POST /api/v1/Invoice</code> mit Positionen, Steuersätzen und Zahlungsbedingungen.</li>
      <li><strong>Rechnung finalisieren:</strong> <code>PUT /api/v1/Invoice/{id}/sendViaEmail</code> versendet die Rechnung direkt als E-Rechnungsdatei.</li>
      <li><strong>Status überwachen:</strong> <code>GET /api/v1/Invoice/{id}</code> liefert den aktuellen Status — erstellt, versendet, bezahlt oder überfällig.</li>
    </ol>
    <p>
    ...
    <h2>DATEV-Export und Steuerberater-Integration</h2>
    <p>
    ...
    <ul>
      <li>Buchungssätze im DATEV-Format (ASCII/CSV)</li>
      <li>Belegbilder und E-Rechnungsdateien als Anhänge</li>
      <li>Zuordnung zu Sachkonten nach SKR 03 oder SKR 04</li>
    </ul>
    <p>
      Der DATEV-Export lässt sich per API automatisieren: <code>GET /api/v1/Export/datev</code> liefert die Exportdatei für einen definierten Zeitraum. In Kombination mit einem Cronjob oder Webhook erstellen Sie so einen vollautomatischen monatlichen Export an Ihren Steuerberater.
    </p>
    <p>
    ...
    <h3>Internationale Rechnungen und Multi-Currency</h3>
    <p>
    ...
    <h3>Hohe Volumina und Batch-Verarbeitung</h3>
    <p>
    ...
    <h3>Branchenerweiterungen nach EN 16931</h3>
    <p>
    ...
    <h2>Wann lohnt sich eine individuelle E-Rechnungslösung?</h2>
    <p>
    ...
    <ul>
      <li>Mehr als 200 Rechnungen pro Monat mit Automatisierungsbedarf</li>
      <li>Branchenspezifische E-Rechnungsformate oder Erweiterungen</li>
      <li>Komplexe Teilrechnungs-Logik mit automatischer Schlussrechnung</li>
      <li>Multi-ERP-Integration oder Anbindung an Warenwirtschaftssysteme</li>
      <li>Vollautomatischer Rechnungseingang mit KI-gestützter Belegerfassung</li>
    </ul>
    <p>
    ...
    <p>
      <router-link to="/e-rechnung">Mehr zu unseren E-Rechnungslösungen →</router-link>
    </p>

    <RelatedArticles slug="e-rechnung-sevdesk" />
  </article>
</template>
